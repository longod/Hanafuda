...
local this = {
    ...
    ["hanafuda.card.name_02_3"] = "Plum Blossom",
    ["hanafuda.card.name_02_4"] = "Plum Blossom",
    ...
    ["hanafuda.card.name_09_1"] = "Sake Cup and Chrysanthemum", -- unconfirmed
    ...
    ["hanafuda.card.name_11_1"] = "Rainman and Willow", -- unconfirmed
